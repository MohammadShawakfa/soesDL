...
#initalize the variable to hold all face locations in the frame
all_face_locations =[]
...
while True:
    ...
    for index,current_face_location in enumerate(all_face_locations):
        ...
        #change the postion magnitude to fit the actual size video frame
        top_pos = top_pos*4
        ...
        #draw rectangle around the face deteced
